      ...
      <View style={viewerStyles.root}>
        ...
        <View style={viewerStyles.header}>
          <Avatar
            ...
            size={36}
            showRing={currentGroup.hasUnviewed}
          />
          <View style={{ flex: 1, marginLeft: 10 }}>
            <Text style={viewerStyles.username}>
...
export default function Stories({ navigation }: StoriesProps) {
  ...
  // ── Botão "meu story": abre viewer se já tem story, senão abre o editor ──
    ...
    <>
      ...
      >
        ...
        <TouchableOpacity style={styles.item} onPress={handleMyStoryPress} activeOpacity={0.8}>
          {myGroup ? (
            // Já tem story — mostrar ring colorido
            <LinearGradient
            ...
            // Sem story — mostrar avatar com botão "+"
